  ...
  void _loadProducts() {
    _allProducts = [
      Product(
        ...
        precio: 299.99,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1zVJBPaXYBkGO3MRfAvPkAUCfH9kZmDW_',
      ...
      Product(
        ...
        precio: 12.50,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1kd8TgXrDaU5ywDQ0nAVXbDuzUEJsCPQB',
        categoria: 'Tornillos',
        marca: 'Stanley',
        stock: 50,
        rating: 4.2,
      ...
      Product(
        id: 3,
        nombre: 'Pintura Látex Mate Blanco 4GL',
        descripcion: 'Pintura látex lavable para interiores',
        precio: 116.90,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1DCXwTsPZmJ2WLWrWtSW1wj_M76xARvdg',
        categoria: 'Pinturas',
        marca: 'FAST',
        stock: 8,
        rating: 4.5,
      ...
      Product(
        ...
        precio: 28.75,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1Ozf-Nnw2ndte4QoAo5aLrcuO4ofjBePq',
      ...
      Product(
        id: 5,
        nombre: 'Llave Ajustable Cromada Stanley  12"',
        descripcion: 'Llave inglesa ajustable de 12 pulgadas',
        precio: 59.90,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1-bBn8Ff7UNHeT115aOag0_yLclzZS_LU',
        categoria: 'Herramientas',
        marca: 'Stanley',
        stock: 12,
        rating: 4.6,
      ...
      Product(
        ...
        precio: 18.50,
        imagenUrl: 'https://drive.google.com/uc?export=view&id=1P9S4E3v3CBEI2Kl8h8jou3YaXMRa3jaf',
        categoria: 'Plomeria',
        marca: 'PAVCO',
        stock: 25,
        rating: 4.3,
